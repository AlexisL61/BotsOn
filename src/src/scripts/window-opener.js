...
function openMainWindow() {
    ...
    mainWindow = new BrowserWindow({
        icon: __dirname + '/../../public/assets/images/logos/logo.png',
        width: 1000,
        height: 1000,
        center: true,
        webPreferences: {
...
function openExportWindow() {
    ...
    mainWindow.loadFile('./views/export/export.html')
    return mainWindow
}
...
function openDownloadWindow(screen) {
    ...
    mainWindow.loadFile(path.join(__dirname,'../../public/download.html'))
    return mainWindow
}
...
async function openCanvasWindow() {
    ...
    await currentOpenWebPage.loadFile('../../views/canvas/canvas.html')
